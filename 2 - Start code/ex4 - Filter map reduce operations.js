...
function filterEvenNumbers(arr) {
  ...
  return arr.filter(num => num % 2== 0); // still volue 
}
...
function squareNumbers(arr) {
  //  TODO - Your code here (1 line)
  return arr.map(num => num * num);  // [1, 4, 9, 16, 25]
}
...
function sumArray(arr) {
  //  TODO - Your code here (1 line)
  return arr.reduce((sum, num) => sum + num, 0);  // 15  // the sum of the numbers in the array [1, 2, 3, 4, 5]  // 15  // the sum of the numbers in the array [1, 2, 3, 4, 5]  // 15  // the sum of the numbers in the array [1, 2, 3, 4, 5]  // 15  // the sum of the numbers in the array [1, 2, 3, 4, 5]  // 15  // the sum of the numbers in the array [1, 2, 3, 4, 5]  // 15  // the sum of the numbers in the array [1, 2, 3, 4, 5]  //
}
